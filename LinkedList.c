...
LinkedList* ll_filterParametros(LinkedList* this, int (*fn)(void* element, char* cadena), char* parmCadena)
{
    LinkedList* filterList=NULL;
    int i;
    int len;
    ...
    if(this != NULL && fn != NULL && parmCadena != NULL)
    {
        len=ll_len(this);
        filterList=ll_newLinkedList();
        for(i=0; i<len; i++)
